...
#if !defined( _SIGSCANTOOLS_GETOPT_H )
#define _SIGSCANTOOLS_GETOPT_H
...
typedef struct sigscantools_option sigscantools_option_t;

struct sigscantools_option
{
...
#define sigscantools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t sigscantools_getopt(
                  int argument_count,
...
void sigscantools_getopt_wrapped_fprint(
      FILE *stream,
...
void sigscantools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const sigscantools_option_t *options,
      int number_of_options );

int sigscantools_getopt_get_options_string(
     const sigscantools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _SIGSCANTOOLS_GETOPT_H ) */
