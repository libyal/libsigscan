...
PyTypeObject pysigscan_signature_flags_type_object = {
	...
	/* tp_name */
	"pysigscan.signature_flags",
	/* tp_basicsize */
	sizeof( pysigscan_signature_flags_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pysigscan_signature_flags_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_init */
	(initproc) pysigscan_signature_flags_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
/* Creates a new signature flags object
