...
#if !defined( _LIBSIGSCAN_EXTERN_H )
#define _LIBSIGSCAN_EXTERN_H

/* To export functions from the libsigscan DLL define LIBSIGSCAN_DLL_EXPORT
 * To import functions from the libsigscan DLL define LIBSIGSCAN_DLL_IMPORT
