...
{
	static char *function = "libsigscan_notify_set_stream";
...
int libsigscan_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libsigscan_notify_stream_open";
...
int libsigscan_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libsigscan_notify_stream_close";
