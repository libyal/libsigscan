...
#include "libsigscan_libclocale.h"
...
const char *libsigscan_get_version(
             void )
{
	return( (const char *) LIBSIGSCAN_VERSION_STRING );
}
...
int libsigscan_get_access_flags_read(
     void )
{
	return( (int) LIBSIGSCAN_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libsigscan_get_codepage";
...
int libsigscan_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libsigscan_set_codepage";
