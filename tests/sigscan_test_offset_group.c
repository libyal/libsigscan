/*
 * Library offset_group type testing program
 *
...
#endif
{
	...
	/* TODO: add tests for libsigscan_offset_group_initialize */

	SIGSCAN_TEST_RUN(
	 "libsigscan_offset_group_free",
	 sigscan_test_offset_group_free );

	/* TODO: add tests for libsigscan_offset_group_compare */

	/* TODO: add tests for libsigscan_offset_group_get_weight */

	/* TODO: add tests for libsigscan_offset_group_get_number_of_offsets */

	/* TODO: add tests for libsigscan_offset_group_get_offset_by_index */

	/* TODO: add tests for libsigscan_offset_group_append_offset */
