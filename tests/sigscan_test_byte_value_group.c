/*
 * Library byte_value_group type testing program
 *
...
#endif
{
	...
	/* TODO: add tests for libsigscan_byte_value_group_initialize */

	SIGSCAN_TEST_RUN(
	 "libsigscan_byte_value_group_free",
	 sigscan_test_byte_value_group_free );

	/* TODO: add tests for libsigscan_byte_value_group_compare */

	/* TODO: add tests for libsigscan_byte_value_group_get_pattern_offset */

	/* TODO: add tests for libsigscan_byte_value_group_get_signature_group */

	/* TODO: add tests for libsigscan_byte_value_group_insert_signature */

	/* TODO: add tests for libsigscan_byte_value_group_get_number_of_signature_groups */

	/* TODO: add tests for libsigscan_byte_value_group_get_signature_group_by_index */
