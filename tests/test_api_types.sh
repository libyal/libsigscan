...
TEST_TYPES="byte_value_group offset_group pattern_weights scan_object scan_result scan_state scan_tree scan_tree_node scanner signature signature_group signature_table skip_table weight_group";
