/*
 * Library scan_object type testing program
 *
...
#endif
{
	...
	/* TODO: add tests for libsigscan_scan_object_initialize */

	SIGSCAN_TEST_RUN(
	 "libsigscan_scan_object_free",
	 sigscan_test_scan_object_free );

	/* TODO: add tests for libsigscan_scan_object_get_type */

	/* TODO: add tests for libsigscan_scan_object_get_value */

	/* TODO: add tests for libsigscan_scan_object_printf */
