...
#if !defined( _SIGSCAN_TEST_GETOPT_H )
#define _SIGSCAN_TEST_GETOPT_H
...
#define sigscan_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t sigscan_test_getopt(
                  int argument_count,
...
#endif /* !defined( _SIGSCAN_TEST_GETOPT_H ) */
